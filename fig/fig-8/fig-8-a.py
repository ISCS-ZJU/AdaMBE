...
c = canvas(ctype, title='fig-8-a', dimensions=[1500, 350])


######################################real_time#################################

t = table(file='fig-8-a.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.0015, 300000], dimensions=[pictureWidthLong, pictureHeightLong], coord=[30,30], yscale='log10')
...
#          xlabelrotate=20,
        xaxisposition=0.0012, #yauto=['','',0.5], 
        # xlabelshift=[0, -1],
