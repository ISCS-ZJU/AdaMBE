...
c = canvas(ctype, title='fig-10-b', dimensions=[400, 200])


######################################real_time#################################

t = table(file='fig-10-b.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0, 1140], dimensions=[pictureWidthShort, pictureHeight], coord=[40,30])#, yscale='log10')

axis(drawable=d,style='y',ticstyle='in',
     doxmajortics=False,doymajortics=True,
     ymanual=[['0', 0],['200', 200],['400', 400],['600', 600],['800', 800], ['1000', 1000]],
     ticmajorsize = 3,         
