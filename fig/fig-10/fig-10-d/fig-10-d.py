...
c = canvas(ctype, title='fig-10-d', dimensions=[400, 200])


######################################real_time#################################

t = table(file='fig-10-d.data')
...
#series_names = ['MBEA','iMBEA','PMBE','MineLMBC','FMBE','MMBEA_FAST','MMBEA_MIN','MMBEA']
...
#### legend
L.draw(canvas=c, coord=[d.left()+4, d.top()+18], skipnext=2, skipspace=174,
