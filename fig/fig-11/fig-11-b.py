...
c = canvas(ctype, 'fig-11-b', dimensions=[400, 300])

t = table(file='fig-11.data')

# print(min_value)

d = drawable(canvas=c, xrange=[0, 270],
             yrange=[0, 4300], dimensions=[pictureWidthMini, pictureHeightMini], coord=[40,30])
...
axis(drawable=d, style='box', ticstyle='in', dominortics=False,
     ...
     ymanual=[['0',0],['1000', 1000],['2000',2000],['3000',3000],['4000',4000]],
...
L.draw(canvas=c, coord=[d.left()+45, d.top()-12], width=5, height=2.5, fontsize=legendTextSize, skipnext=1, skipspace=120)
L_line.draw(canvas=c, coord=[d.left()+42, d.top()-12], width=10, height=15, fontsize=legendTextSize, skipnext=1, skipspace=120)
